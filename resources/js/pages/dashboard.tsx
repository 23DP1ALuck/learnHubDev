...
export default function Dashboard() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            {(flash?.afterLogin && auth.organizations.length > 1) && <JoinedOrg organizations={auth.organizations} showList={open} onOpenChange={onOpenChange} currentOrganization={auth.currentOrganization}/>}
