            ...
            <div className="flex flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <div className="flex justify-between">
                    <div className="space-y-1">
                        <h1 className="text-2xl font-semibold tracking-tight">Preview task</h1>
                        <p className="text-sm text-muted-foreground">
                            Teacher preview for {assignment.title}. This page shows how the task is positioned inside the assignment flow.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid min-h-0 flex-1 gap-4 xl:grid-cols-[minmax(0,1.6fr)_minmax(18rem,22rem)]">
                    ...
                    <TaskPreviewSidebar assignment={assignment} task={task} taskNavigation={taskNavigation} />
                </div>
            </div>
        </AppLayout>
    );
