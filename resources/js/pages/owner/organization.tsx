            ...
            <div className="flex flex-1 flex-col gap-4 rounded-xl p-4">
                <Card className="border-sidebar-border/70">
                    <CardHeader>
                        ...
                        <CardDescription>Core information about your organization workspace.</CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-4 md:grid-cols-2">
                        <div className="rounded-lg border p-4">
                            <p className="text-sm text-muted-foreground">Type</p>
                            <p className="mt-1 font-medium capitalize">{organization.organization_type}</p>
                        </div>
                        <div className="rounded-lg border p-4">
                ...
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
                    {Object.entries(stats).map(([label, value]) => (
                        <Card key={label} className="border-sidebar-border/70">
                            <CardHeader>
                                <CardDescription>{label.replace('_', ' ')}</CardDescription>
