...
export function PrimaryFeatures() {
    ...
    return (
        <section
            id="features"
            aria-label={t('landing.Features for running your books')}
            className="relative mt-70 overflow-hidden bg-blue-600 pt-20 pb-28 sm:py-32"
        >
            <img
            ...
            <Container className="relative">
                <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
                    <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
                        {t('landing.Viss, kas vajadzīgs mācību pārvaldībai.')}
                    </h2>
                    <p className="mt-6 text-lg tracking-tight text-blue-100">
                        {t(
                            'landing.Moduļi, materiāli, uzdevumi, atzīmes un čati — viss vienuviet un sakārtoti.',
                        )}
                    </p>
                </div>
                <TabGroup
                            ...
                            <TabPanels className="lg:col-span-7">
                                {features.map((feature) => (
                                    ...
                                    >
                                        ...
                                        <div className="relative mt-10 w-180 overflow-hidden rounded-xl bg-slate-50 shadow-xl shadow-blue-900/20 sm:w-auto lg:mt-0 lg:w-271.25">
                                            <img
                                                className="w-full"
                                                src={feature.image}
                                                alt=""
