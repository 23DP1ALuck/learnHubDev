...
export const OnboardingRequestsList = ({
    ...
    return (
        <div className="relative w-full overflow-auto rounded-xl border border-sidebar-border/70 bg-white dark:border-sidebar-border dark:bg-background">
            <div className="min-w-[900px]">
                <div className="grid grid-cols-[2fr_2fr_1.5fr_1fr_1.5fr] gap-6 border-b border-border bg-muted/30 px-6 py-3 text-xs font-semibold tracking-wide text-muted-foreground uppercase">
                    <div>{t('common.Name')}</div>
                    <div>{t('owner.Organization')}</div>
                    <div>{t('common.Submitted')}</div>
