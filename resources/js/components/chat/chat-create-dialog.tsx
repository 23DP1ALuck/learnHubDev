...
export default function ChatCreateDialog({
    ...
    const initialScope: ChatRecipientScope =
        recipientPools.class.length > 0 ? 'CLASS' : 'ORGANIZATION';
    ...
    const recipients = useMemo(
        () =>
            scope === 'CLASS'
                ? recipientPools.class
                : recipientPools.organization,
    ...
    const toggleRecipient = (recipientId: number, checked: boolean) => {
        if (chatType === 'PRIVATE') {
            // if private chat select new one, remove from old one
    ...
    return (
        ...
        >
            ...
            <DialogContent className="max-w-3xl">
                <DialogHeader>
                    <DialogTitle>{t('chat.Create chat')}</DialogTitle>
                    <DialogDescription>
                        {t(
                            'chat.For the MVP, let users start private chats or create custom groups. Module chats remain a separate system type from the documentation.',
                        )}
                    </DialogDescription>
                </DialogHeader>
                    ...
                    {({ processing, errors }) => (
                        <>
                            ...
                            <div className="grid gap-6">
                                ...
                                <div className="grid max-h-[30vh] gap-3 overflow-y-auto rounded-3xl border bg-card/50 p-4">
                                        ...
                                        <div>
                                            <p className="font-medium">
                                                {scope === 'CLASS'
                                                    ...
                                                    : t(
                                                          'owner.Users in the organization',
                                                      )}
                                            </p>
                                            <p className="text-sm text-muted-foreground">
                                                {chatType === 'PRIVATE'
                                                    ? t(
                                                          'chat.Select one recipient for a private conversation.',
                                                      )
                                                    : t(
                                                          'chat.Select at least two recipients for the group chat.',
                                                      )}
                                            </p>
                                        </div>
                                    ...
                                    {recipients.length === 0 ? (
                                        <div className="rounded-2xl border border-dashed p-8 text-center text-sm text-muted-foreground">
                                            {t(
                                                'chat.No recipients are available in this scope yet.',
                                            )}
                                        </div>
                                    ) : (
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="min-w-0 space-y-1 overflow-y-auto">
                                                            ...
                                                            <div className="flex">
                                                                {recipient.module_names
                                                                    ? recipient.module_names.map(
                                                                          (
                                                                              name,
                                                                          ) => (
                                                                              <Badge
