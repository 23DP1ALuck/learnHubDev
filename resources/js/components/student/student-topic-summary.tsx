...
type StudentTopicSummaryProps = {
    ...
    topic: Pick<
        StudentTopicSummary,
        'name' | 'description' | 'materials_count' | 'assignments_count'
    >;
};
export default function StudentTopicSummaryCard({
    module,
    topic,
}: StudentTopicSummaryProps) {
    ...
    return (
        <Card className="border-sidebar-border/70">
            <CardHeader>
                ...
                <CardDescription>
                    {topic.description ||
                        'This topic contains the materials and assignments students work through.'}
                </CardDescription>
            </CardHeader>
