    ...
    return (
        <Card className="border-sidebar-border/70">
            <CardHeader>
                ...
                <CardDescription>
                    {t(
                        'teacher.Each topic leads to its own workspace where you manage materials and assignments.',
                    )}
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
                {topics.length === 0 ? (
                    <div className="rounded-lg border border-dashed p-8 text-center text-sm text-muted-foreground">
                        {t(
                            'teacher.No topics yet. Create the first topic for this module.',
                        )}
                    </div>
                ) : (
                    topics.map((topic) => (
                        ...
                        >
                            <div className="space-y-2">
                                ...
                                <div className="flex flex-wrap gap-3 text-xs text-muted-foreground">
                                    ...
                                    <span>
                                        Assignments: {topic.assignments_count}
                                    </span>
                                    <span>
                                        {t('teacher.Topic #')}
                                        {topic.topic_id}
