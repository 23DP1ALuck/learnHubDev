...
export default function ModuleTopicsCreate({
    moduleId,
}: ModuleTopicsCreateProps) {
    const { t } = useTranslation();
    return (
        <Card className="overflow-y-auto border-sidebar-border/70 py-5">
            <CardHeader>
                <CardTitle>{t('learning.Create topic')}</CardTitle>
                <CardDescription>
                    {t(
                        'teacher.Topics are the second level in the documentation hierarchy, directly inside a module.',
                    )}
                </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    {({ processing, errors }) => (
                        <>
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="name">
                                    {t('learning.Topic name')}
                                </Label>
                                <Input
                                    id="name"
                                    name="name"
                                    placeholder={t(
                                        'teacher.Variables and data types',
                                    )}
                                />
                            ...
                            <div className="grid gap-2">
                                ...
                                <textarea
                                    ...
                                    placeholder={t(
                                        'teacher.Short explanation of what students will learn in this topic.',
                                    )}
                                />
