...
export default function MaterialFilesList({
    files,
    materialContext,
}: MaterialFilesListProps) {
            ...
            <CardHeader>
                <div className="flex justify-between">
                    <div className="flex flex-col gap-1.5">
                        <CardTitle>{t('learning.Linked files')}</CardTitle>
                        <CardDescription>
                            {t('learning.Files attached to this material.')}
                        </CardDescription>
                    </div>
            ...
            <CardContent className="space-y-3">
                {files.length === 0 ? (
                    <div className="rounded-lg border border-dashed p-8 text-center text-sm text-muted-foreground">
                        {t('teacher.No files linked to this material yet.')}
                    </div>
                ) : (
                    files.map((file) => (
