...
export default function EditTopicForm({ topic }: EditTopicFormProps) {
    ...
    return (
        <Card className="border-sidebar-border/70">
            <CardHeader>
                <CardTitle>{t('learning.Topic details')}</CardTitle>
                <CardDescription>
                    {t(
                        'teacher.Change the topic title and summary shown inside the module workspace.',
                    )}
                </CardDescription>
            </CardHeader>
            <CardContent>
                <Form
                    action={route('topics.update', [
                        topic.module_id,
                        topic.topic_id,
                    ])}
                    method="patch"
