    ...
    return (
        <Card className="border-sidebar-border/70">
            <CardHeader>
                ...
                <CardDescription>
                    Change the title, schedule, and short summary shown across the teacher workspace.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <Form action={route('modules.update', module.id)} method="patch" className="grid gap-4">
                    {({ processing, errors }) => (
                        <>
                            <div className="grid gap-2">
                                <Label htmlFor="name">Module name</Label>
                                <Input id="name" name="name" defaultValue={module.name} />
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="grid gap-2">
                                    ...
                                    <Input id="start_date" name="start_date" type="date" defaultValue={module.start_date ?? ''} />
                                    <InputError message={errors.start_date} />
                                </div>
                                <div className="grid gap-2">
                                    <Label htmlFor="end_date">End date</Label>
                                    <Input id="end_date" name="end_date" type="date" defaultValue={module.end_date ?? ''} />
                            ...
                            <div className="flex items-center justify-between gap-3">
                                <Button variant="outline" asChild>
                                    <Link href={route('teacher.modules.show', module.id)}>Back to module</Link>
                                </Button>
            ...
            <div className="w-full px-4">
                <DeleteModule module={{id: module.id, name: module.name}} onFullWidth={true}/>
            </div>
